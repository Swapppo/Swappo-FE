    ...
    <View className="flex-1 bg-cream">
      ...
      <ScrollView className="flex-1 px-6">
        ...
        <View className="mb-8 mt-2">
          ...
          <Text className="text-3xl font-manrope tracking-tight text-dark mt-1">
            Ready to trade?
          </Text>
        </View>
          ...
          <View className="relative">
            ...
            <View className="relative bg-primary rounded-4xl p-8 shadow-xl">
              <View className="relative z-10">
                <Text className="font-manrope text-3xl tracking-tight mb-2 text-white">
                  Start Swiping
                </Text>
        ...
        <View className="mb-8">
          <View className="flex-row justify-between items-end mb-4">
            <Text className="font-manrope text-xl tracking-tight text-dark">
              Your Listings
            </Text>
